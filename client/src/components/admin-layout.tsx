          ...
          <div className="rounded-2xl border border-black/10 bg-w p-5 dark:border-white/10">
            ...
            <div className="mt-6">
              ...
              <div className="mt-3 flex flex-col gap-2">
                ...
                <AdminNavItem href="/admin/ai-image" icon="ri-image-line" label={t("ai_image.title")} />
                ...
                <AdminNavItem href="/admin/music-status" icon="ri-music-2-line" label={t("admin.music_status.title")} />
              </div>
            </div>
          </div>
        </aside>
